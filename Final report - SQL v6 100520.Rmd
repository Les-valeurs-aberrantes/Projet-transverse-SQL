...
author: 'Tran Nam Maï, Clara Lucas, Salomon Hazan'
date: "May 10, 2020"
output:
  html_notebook:
    toc: true
...
X1a <- read_delim("Data/New dataset/1a.CSV", 
   "|", escape_double = FALSE, trim_ws = TRUE)
X1b <- read_delim("Data/New dataset/1b.CSV", 
    "|", escape_double = FALSE, trim_ws = TRUE)
X1c <- read_delim("Data/New dataset/1c.CSV", 
    "|", escape_double = FALSE, trim_ws = TRUE)
X2a <- read_delim("Data/New dataset/2a.CSV", 
   "|", escape_double = FALSE, trim_ws = TRUE)
X2b <- read_delim("Data/New dataset/2b.CSV", 
    "|", escape_double = FALSE, trim_ws = TRUE)
X3a <- read_delim("Data/New dataset/3a.CSV", 
    "|", escape_double = FALSE, trim_ws = TRUE)
X3b <- read_delim("Data/New dataset/3b.CSV", 
    "|", escape_double = FALSE, trim_ws = TRUE)
```
# I. Etude globale
...
general <- formatter("span",
  style = x ~ style(
    ...
    color = csscolor(gradient(x, "black", "black"))
  ))
formattable(X3b, list(rentabilite = general))
```
